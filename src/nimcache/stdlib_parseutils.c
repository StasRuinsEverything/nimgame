...
N_LIB_PRIVATE N_NIMCALL(NI, parseIdent_tLWlhTCVyzkdnYs1ielKLg)(NimStringDesc* s, NimStringDesc** ident, NI start) {
	NI result;
	NI i;
	nimfr_("parseIdent", "parseutils.nim");
	result = (NI)0;
	nimln_(110, "parseutils.nim");
	i = start;
	nimln_(111, "parseutils.nim");
	{
		NI TM_vI9aZNKIcImom6dDyKXW1ZA_12;
		NI TM_vI9aZNKIcImom6dDyKXW1ZA_14;
		NI TM_vI9aZNKIcImom6dDyKXW1ZA_15;
		if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
		if (!(((NU8)(s->data[i])) >= ((NU8)(97)) && ((NU8)(s->data[i])) <= ((NU8)(122)) || ((NU8)(s->data[i])) >= ((NU8)(65)) && ((NU8)(s->data[i])) <= ((NU8)(90)) || ((NU8)(s->data[i])) == ((NU8)(95)))) goto LA3_;
		nimln_(112, "parseutils.nim");
		TM_vI9aZNKIcImom6dDyKXW1ZA_12 = addInt(i, ((NI) 1));
		i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_12);
		{
			nimln_(113, "parseutils.nim");
			while (1) {
				NI TM_vI9aZNKIcImom6dDyKXW1ZA_13;
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				if (!(((NU8)(s->data[i])) >= ((NU8)(97)) && ((NU8)(s->data[i])) <= ((NU8)(122)) || ((NU8)(s->data[i])) >= ((NU8)(65)) && ((NU8)(s->data[i])) <= ((NU8)(90)) || ((NU8)(s->data[i])) >= ((NU8)(48)) && ((NU8)(s->data[i])) <= ((NU8)(57)) || ((NU8)(s->data[i])) == ((NU8)(95)))) goto LA6;
				TM_vI9aZNKIcImom6dDyKXW1ZA_13 = addInt(i, ((NI) 1));
				i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_13);
			} LA6: ;
		}
		nimln_(114, "parseutils.nim");
		TM_vI9aZNKIcImom6dDyKXW1ZA_14 = subInt(i, ((NI) 1));
		unsureAsgnRef((void**) (&(*ident)), copyStrLast(s, start, (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_14)));
		nimln_(115, "parseutils.nim");
		TM_vI9aZNKIcImom6dDyKXW1ZA_15 = subInt(i, start);
