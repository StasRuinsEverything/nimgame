...
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_139635_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_139801_;
...
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_140432_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_140434_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_139818_;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nososErrorMsg)(void) {
	...
	nimln_(25, "oserr.nim");
	{
		...
		nimln_(28, "oserr.nim");
		{
			...
			nimln_(28, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_139635_(((NI32) 5119), NIM_NIL, err, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	nimln_(77, "oserr.nim");
	{
		...
		nimln_(80, "oserr.nim");
		{
			...
			nimln_(80, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_139635_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			nimln_(82, "oserr.nim");
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			nimln_(83, "oserr.nim");
